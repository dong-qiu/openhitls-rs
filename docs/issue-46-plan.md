...
|---|---------|-------------|-------------------------:|----------|
| **plan** | **T195** | (this doc) + 5–8 representative frame_config negatives | ~10 | **plan + first batch** |
| 46-A | T196 | `frame_config_interface` remainder | ~10 | Migrate novel set/get + version-gate negatives |
