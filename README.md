...
> **100% C→Rust feature parity achieved** — 4083 tests, 68 fuzz targets, 5000+ Wycheproof vectors
...
| Test Infrastructure | ~20K | ~3.5K | **95%** | 4083 tests + Wycheproof + 68 fuzz targets (447 corpus) + security audit |
...
# Run all tests (4083 tests, 35 ignored)
