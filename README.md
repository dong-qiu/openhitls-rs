...
> **100% C→Rust feature parity achieved** — 3280 tests, 14 fuzz targets, 5000+ Wycheproof vectors
...
| Test Infrastructure | ~20K | ~3.5K | **95%** | 3280 tests + Wycheproof + 14 fuzz targets + security audit |
...
This project is a Rust rewrite of [openHiTLS](https://gitee.com/openhitls/openhitls), an open-source cryptographic and TLS library originally written in C. See [DEV_LOG.md](DEV_LOG.md) for the detailed migration history (Phase 0–79).
