...
├── tests/interop/       # Integration tests: 85 cross-crate tests including TCP loopback, DTLS 1.2, TLCP, DTLCP, mTLS (3 ignored)
...
cargo test -p hitls-integration-tests       # 85 tests (3 ignored)
...
| Test Infrastructure | ~20K | ~3.5K | **95%** (2036 tests + 5000+ Wycheproof vectors + 10 fuzz targets + security audit) | SDV compliance tests |
