...
> **100% C→Rust feature parity achieved** — 4222 tests, 68 fuzz targets, 5000+ Wycheproof vectors
...
| Test Infrastructure | ~20K | ~3.5K | **95%** | 4222 tests + Wycheproof + 68 fuzz targets (447 corpus) + OpenSSL TLS interop + security audit |
...
# Run all tests (4222 tests, 43 ignored)
...
cargo test -p hitls-cli --all-features      # 171 tests (5 ignored)
cargo test -p hitls-integration-tests       # 269 tests (12 ignored)
...
This project is a Rust rewrite of [openHiTLS](https://gitee.com/openhitls/openhitls), an open-source cryptographic and TLS library originally written in C. See [DEV_LOG.md](DEV_LOG.md) for the detailed migration history (Phases I1–I95, T1–T119, R1–R13, P1–P94).
