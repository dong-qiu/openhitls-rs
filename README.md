...
> **100% C→Rust feature parity achieved** — 2724 tests, 10 fuzz targets, 5000+ Wycheproof vectors
...
| Test Infrastructure | ~20K | ~3.5K | **95%** | 2724 tests + Wycheproof + 10 fuzz targets + security audit |
...
cargo test -p hitls-crypto --all-features   # 709 tests + 15 Wycheproof
...
cargo test -p hitls-integration-tests       # 149 tests
