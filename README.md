...
> **100% C→Rust feature parity achieved** — 4205 tests, 68 fuzz targets, 5000+ Wycheproof vectors
...
| Test Infrastructure | ~20K | ~3.5K | **95%** | 4205 tests + Wycheproof + 68 fuzz targets (447 corpus) + OpenSSL TLS interop + security audit |
...
# Run all tests (4205 tests, 43 ignored)
...
cargo test -p hitls-integration-tests       # 263 tests (12 ignored)
