...
> **100% C→Rust feature parity achieved** — 4148 tests, 68 fuzz targets, 5000+ Wycheproof vectors
...
| Test Infrastructure | ~20K | ~3.5K | **95%** | 4148 tests + Wycheproof + 68 fuzz targets (447 corpus) + OpenSSL TLS interop + security audit |
...
# Run all tests (4148 tests, 42 ignored)
cargo test --workspace --all-features

# Run tests for a specific crate
cargo test -p hitls-crypto --all-features   # 1485 tests (24 ignored)
cargo test -p hitls-tls --all-features      # 1507 tests
cargo test -p hitls-pki --all-features      # 442 tests
