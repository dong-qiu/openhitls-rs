...
│   ├── hitls-pki/       # X.509 (parse, verify [RSA/ECDSA/Ed25519/Ed448/SM2/RSA-PSS], chain, CRL, OCSP, CSR generation, certificate generation, to_text), PKCS#8 (RFC 5958), PKCS#12 (RFC 7292), CMS SignedData (Ed25519/Ed448) + EnvelopedData (RFC 5652) (313 tests, 1 ignored)
...
cargo test -p hitls-pki --all-features      # 125 tests (1 ignored)
