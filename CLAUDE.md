...
- **Status**: Phase 97 complete + Phase T134 — ML-DSA poly + X.509 extensions + X.509 text deepening (3154 tests, 7 ignored)
...
│   ├── hitls-crypto/    # Cryptographic algorithms (feature-gated): AES, SM4, ChaCha20, SHA-2/3, SM3, HMAC, RSA, ECC, Ed25519/448, X25519/448, DH, DSA, SM2, SM9, PQC (ML-KEM/ML-DSA/SLH-DSA/XMSS/FrodoKEM/McEliece), DRBG, FIPS/CMVP, entropy health, hardware AES/SHA-2/GHASH/ChaCha20, P-256 fast path (994 tests + 15 Wycheproof, 2 ignored)
...
# Run all tests (3154 tests, 7 ignored)
cargo test --workspace --all-features

# Run tests for a specific crate
cargo test -p hitls-crypto --all-features   # 994 tests (2 ignored) + 15 Wycheproof
...
Phase 0–97 complete + Phase T73–T134 + Phase R102–R113 (3154 tests, 7 ignored). **100% C→Rust feature parity achieved. Architecture refactoring complete. Performance optimization phase complete.**
