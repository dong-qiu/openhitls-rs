...
│   ├── hitls-pki/       # X.509 (parse, verify, chain, CRL, OCSP, CSR generation, Certificate generation, to_text output, SigningKey abstraction), PKCS#12 (RFC 7292), CMS SignedData (Ed25519/Ed448) + EnvelopedData + EncryptedData + DigestedData (RFC 5652), PKCS#8 (RFC 5958) (125 tests, 1 ignored)
...
Phases 0-49 + P1 complete (1362 tests, 37 ignored).
