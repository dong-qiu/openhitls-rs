...
- **Status**: Phases I1–I95, T1–T119, R1–R13, P1–P94 complete (4360 tests, 43 ignored; 1 pre-existing TLS-1.2 integration failure from T117 tracked for follow-up; T64 skipped + T112–T116 reserved; T111 in progress — `docs/c-test-migration-plan.md` Phase A is 5/9 algorithms done)
