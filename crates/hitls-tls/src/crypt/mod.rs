...
impl Tls12CipherSuiteParams {
    ...
    pub fn from_suite(suite: CipherSuite) -> Result<Self, TlsError> {
        match suite {
            ...
            // --- ECDHE-CCM suites (RFC 7251, PRF=SHA-256, AEAD) ---
            CipherSuite::TLS_ECDHE_ECDSA_WITH_AES_128_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Ecdhe,
                auth_alg: AuthAlg::Ecdsa,
                hash_len: 32,
            ...
            CipherSuite::TLS_ECDHE_ECDSA_WITH_AES_256_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Ecdhe,
                auth_alg: AuthAlg::Ecdsa,
                hash_len: 32,
            ...
            // --- ECDHE_ECDSA CCM_8 suites (RFC 7251, 8-byte tag) ---
            CipherSuite::TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Ecdhe,
                auth_alg: AuthAlg::Ecdsa,
                hash_len: 32,
            ...
            CipherSuite::TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Ecdhe,
                auth_alg: AuthAlg::Ecdsa,
                hash_len: 32,
            ...
            // --- RSA static KX CCM suites (RFC 6655) ---
            CipherSuite::TLS_RSA_WITH_AES_128_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Rsa,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            CipherSuite::TLS_RSA_WITH_AES_256_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Rsa,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            // --- RSA CCM_8 suites (RFC 6655, 8-byte tag) ---
            CipherSuite::TLS_RSA_WITH_AES_128_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Rsa,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            CipherSuite::TLS_RSA_WITH_AES_256_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Rsa,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            // --- DHE_RSA CCM suites (RFC 6655) ---
            CipherSuite::TLS_DHE_RSA_WITH_AES_128_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Dhe,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            CipherSuite::TLS_DHE_RSA_WITH_AES_256_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Dhe,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            // --- DHE_RSA CCM_8 suites (RFC 6655, 8-byte tag) ---
            CipherSuite::TLS_DHE_RSA_WITH_AES_128_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Dhe,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            CipherSuite::TLS_DHE_RSA_WITH_AES_256_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Dhe,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            // --- Plain PSK CBC-SHA256/SHA384 suites (RFC 5487) ---
            CipherSuite::TLS_PSK_WITH_AES_128_CBC_SHA256 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Psk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            CipherSuite::TLS_PSK_WITH_AES_256_CBC_SHA384 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Psk,
                auth_alg: AuthAlg::Psk,
                hash_len: 48,
            ...
            // --- Plain PSK CCM suites (RFC 6655) ---
            CipherSuite::TLS_PSK_WITH_AES_128_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Psk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            CipherSuite::TLS_PSK_WITH_AES_256_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Psk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            // --- Plain PSK CCM_8 suites (RFC 6655, 8-byte tag) ---
            CipherSuite::TLS_PSK_WITH_AES_128_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Psk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            CipherSuite::TLS_PSK_WITH_AES_256_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::Psk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            // --- DHE_PSK CBC-SHA256/SHA384 suites (RFC 5487) ---
            CipherSuite::TLS_DHE_PSK_WITH_AES_128_CBC_SHA256 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::DhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            CipherSuite::TLS_DHE_PSK_WITH_AES_256_CBC_SHA384 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::DhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 48,
            ...
            // --- DHE_PSK CCM suites (RFC 6655) ---
            CipherSuite::TLS_DHE_PSK_WITH_AES_128_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::DhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            CipherSuite::TLS_DHE_PSK_WITH_AES_256_CCM => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::DhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            // --- DHE_PSK CCM_8 suites (RFC 6655, 8-byte tag) ---
            CipherSuite::TLS_DHE_PSK_WITH_AES_128_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::DhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            CipherSuite::TLS_DHE_PSK_WITH_AES_256_CCM_8 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::DhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            // --- RSA_PSK CBC-SHA256/SHA384 suites (RFC 5487) ---
            CipherSuite::TLS_RSA_PSK_WITH_AES_128_CBC_SHA256 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::RsaPsk,
                auth_alg: AuthAlg::Rsa,
                hash_len: 32,
            ...
            CipherSuite::TLS_RSA_PSK_WITH_AES_256_CBC_SHA384 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::RsaPsk,
                auth_alg: AuthAlg::Rsa,
                hash_len: 48,
            ...
            // --- ECDHE_PSK GCM suites (draft-ietf-tls-ecdhe-psk-aead) ---
            CipherSuite::TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::EcdhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            CipherSuite::TLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::EcdhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 48,
            ...
            // --- ECDHE_PSK CCM suite (RFC 7251) ---
            CipherSuite::TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::EcdhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
            ...
            // --- ECDHE_PSK CCM_8 suite (draft-ietf-tls-ecdhe-psk-aead, 8-byte tag) ---
            CipherSuite::TLS_ECDHE_PSK_WITH_AES_128_CCM_8_SHA256 => Ok(Self {
                suite,
                kx_alg: KeyExchangeAlg::EcdhePsk,
                auth_alg: AuthAlg::Psk,
                hash_len: 32,
