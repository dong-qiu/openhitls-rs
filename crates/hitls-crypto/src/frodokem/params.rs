...
static PARAMS: [FrodoParams; 12] = [
    // FrodoKEM-640-SHAKE
    FrodoParams {
        n: 640, n_bar: 8, logq: 15, extracted_bits: 2,
        pk_size: 9616, sk_size: 19888, ct_size: 9752, ss_len: 16,
        seed_a_len: 16, seed_se_len: 32, mu_len: 16, pk_hash_len: 16, salt_len: 32,
        cdf_table: &CDF_640, prg: PrgMode::Shake,
    },
    // FrodoKEM-976-SHAKE
    FrodoParams {
        n: 976, n_bar: 8, logq: 16, extracted_bits: 3,
        pk_size: 15632, sk_size: 31296, ct_size: 15792, ss_len: 24,
        seed_a_len: 16, seed_se_len: 48, mu_len: 24, pk_hash_len: 24, salt_len: 48,
        cdf_table: &CDF_976, prg: PrgMode::Shake,
    },
    // FrodoKEM-1344-SHAKE
    FrodoParams {
        n: 1344, n_bar: 8, logq: 16, extracted_bits: 4,
        pk_size: 21520, sk_size: 43088, ct_size: 21696, ss_len: 32,
        seed_a_len: 16, seed_se_len: 64, mu_len: 32, pk_hash_len: 32, salt_len: 64,
        cdf_table: &CDF_1344, prg: PrgMode::Shake,
    },
    // FrodoKEM-640-AES
    FrodoParams {
        n: 640, n_bar: 8, logq: 15, extracted_bits: 2,
        pk_size: 9616, sk_size: 19888, ct_size: 9752, ss_len: 16,
        seed_a_len: 16, seed_se_len: 32, mu_len: 16, pk_hash_len: 16, salt_len: 32,
        cdf_table: &CDF_640, prg: PrgMode::Aes,
    },
    // FrodoKEM-976-AES
    FrodoParams {
        n: 976, n_bar: 8, logq: 16, extracted_bits: 3,
        pk_size: 15632, sk_size: 31296, ct_size: 15792, ss_len: 24,
        seed_a_len: 16, seed_se_len: 48, mu_len: 24, pk_hash_len: 24, salt_len: 48,
        cdf_table: &CDF_976, prg: PrgMode::Aes,
    },
    // FrodoKEM-1344-AES
    FrodoParams {
        n: 1344, n_bar: 8, logq: 16, extracted_bits: 4,
        pk_size: 21520, sk_size: 43088, ct_size: 21696, ss_len: 32,
        seed_a_len: 16, seed_se_len: 64, mu_len: 32, pk_hash_len: 32, salt_len: 64,
        cdf_table: &CDF_1344, prg: PrgMode::Aes,
    },
    // eFrodoKEM-640-SHAKE
    FrodoParams {
        n: 640, n_bar: 8, logq: 15, extracted_bits: 2,
        pk_size: 9616, sk_size: 19888, ct_size: 9720, ss_len: 16,
        seed_a_len: 16, seed_se_len: 16, mu_len: 16, pk_hash_len: 16, salt_len: 0,
        cdf_table: &CDF_640, prg: PrgMode::Shake,
    },
    // eFrodoKEM-976-SHAKE
    FrodoParams {
        n: 976, n_bar: 8, logq: 16, extracted_bits: 3,
        pk_size: 15632, sk_size: 31296, ct_size: 15744, ss_len: 24,
        seed_a_len: 16, seed_se_len: 24, mu_len: 24, pk_hash_len: 24, salt_len: 0,
        cdf_table: &CDF_976, prg: PrgMode::Shake,
    },
    // eFrodoKEM-1344-SHAKE
    FrodoParams {
        n: 1344, n_bar: 8, logq: 16, extracted_bits: 4,
        pk_size: 21520, sk_size: 43088, ct_size: 21632, ss_len: 32,
        seed_a_len: 16, seed_se_len: 32, mu_len: 32, pk_hash_len: 32, salt_len: 0,
        cdf_table: &CDF_1344, prg: PrgMode::Shake,
    },
    // eFrodoKEM-640-AES
    FrodoParams {
