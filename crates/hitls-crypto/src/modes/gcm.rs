...
mod tests {
    ...
    // NIST SP 800-38D Test Case 3: 64-byte PT, no AAD
    #[test]
    fn test_gcm_case3_nist() {
    ...
    // NIST SP 800-38D Test Case 5: 8-byte IV (non-96-bit), with AAD
    #[test]
    fn test_gcm_case5_nist() {
        let key = hex("feffe9928665731c6d6a8f9467308308");
    ...
    // NIST SP 800-38D Test Case 6: 60-byte IV, with AAD
    #[test]
    fn test_gcm_case6_nist() {
        let key = hex("feffe9928665731c6d6a8f9467308308");
        let nonce = hex(
